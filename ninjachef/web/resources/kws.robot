...
##Kewords do cenario receber novo pedido.
...
Então devo receber uma notificação de pedido desse produto
        ${mensagem_esperada}    Convert to String   ${email_cliente} está solicitando o preparo do seguinte prato: Carne de Jaca Louca.
